...
export const en = {
  ...
  'details.toggle': 'Toggle review',
  'details.close': 'Close review',
  'details.empty': 'No files yet',
  ...
  'review.commits.empty': 'No commits',

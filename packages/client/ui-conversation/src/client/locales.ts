...
export const zh = {
  ...
  'review.close': '关闭审查',
  'review.changes': '变更',
  'review.changes.empty': '暂无文件变更',
  'review.changes.stats': '+{added} / −{removed}',
  'review.produced': '本轮产出',
  'review.tasks': '任务',
  'review.tasks.empty': '暂无任务',
  'review.task.completed': '已完成',
  'review.task.inProgress': '进行中',
  'review.task.pending': '待处理',
  'review.details': '详情',
  'todo.title': '任务',
  ...
  'map.jump': '跳到对话：{title}',
  'map.status.done': '已完成',
  'map.status.running': '生成中',
  'map.status.waiting': '等待回复',
  'map.untitled': '未命名消息',
  'map.preview.running': '正在生成本轮回复…',
  'map.preview.empty': '这一轮还没有回复内容。',
...
export const en = {
  ...
  'hero.headline': 'What should we build?',
  ...
  'review.changes.empty': 'No file changes',
  'review.changes.stats': '+{added} / −{removed}',
  'review.produced': 'Produced this turn',
  'review.tasks': 'Tasks',
  'review.tasks.empty': 'No tasks',
  'review.task.completed': 'Completed',
  'review.task.inProgress': 'In progress',
  'review.task.pending': 'Pending',
  ...
  'map.aria': 'Conversation map',
  'map.jump': 'Jump to turn: {title}',
  'map.status.done': 'Completed',
  'map.status.running': 'Generating',
  'map.status.waiting': 'Waiting for reply',
  'map.untitled': 'Untitled message',
  'map.preview.running': 'Generating this turn…',
  'map.preview.empty': 'This turn has no reply yet.',

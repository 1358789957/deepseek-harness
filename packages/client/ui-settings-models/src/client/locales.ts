...
export const en = {
  ...
  plusTest: 'Test',
  plusDocs: 'API docs',
  plusConsole: 'Open Platform console',
  plusCors: 'The browser blocked the cross-origin request. Verify the key in the Open Platform console.',
  plusReenter: 'Enter the key again to test it.',
  plusOk: 'The key works.',
  plusHttp: 'The request failed ({status}).',
  plusEmpty: 'Enter an API key first.',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  plusDocs: 'API 文档',
  plusConsole: '开放平台控制台',
  plusCors: '浏览器拦了跨域，请到开放平台控制台验证。',
  plusReenter: '请重新输入密钥后再测试。',
  plusOk: '密钥可用。',
  plusHttp: '请求失败（{status}）。',
  plusEmpty: '请先输入 API 密钥。',
}
